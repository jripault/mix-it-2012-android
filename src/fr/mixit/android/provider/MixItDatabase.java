...
public class MixItDatabase extends SQLiteOpenHelper {
	...
	private static final int DATABASE_VERSION_2012 = 2;
	private static final int DATABASE_VERSION = DATABASE_VERSION_2012;
...
//		String STARRED_SYNC = "starred_sync";
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		...
		// TODO : managing changing database version
        switch (version) {
        case DATABASE_VERSION_2011:
        	// Nothing to do because currently 2012 is the same as 2012
        }
