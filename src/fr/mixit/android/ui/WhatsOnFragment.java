 ...
 * {@link ActivityStreamFragment} that is visible on tablets on the home screen.
 */
...
/*        if (!UIUtils.isHoneycombTablet(getActivity())) {
			// show a button to display the activity stream screen on small and normal screens
            ...
            view.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    Intent intent = new Intent(getActivity(), ActivityStreamActivity.class);
    ...
    private void setupBefore() {
        ...
        mCountdownTextView = (TextView) getActivity().getLayoutInflater().inflate(R.layout.whats_on_countdown, mRootView, false);
    ...
    private void setupAfter() {
        ...
        getActivity().getLayoutInflater().inflate(R.layout.whats_on_thank_you, mRootView, true);
    }
        ...
        view.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (UIUtils.isHoneycombTablet(getActivity())) {
                    ...
                    // TODO : uncomment after adding ScheduleContract
//                    intent.setData(ScheduleContract.Sessions.buildSessionsAtDirUri(System.currentTimeMillis()));
    ...
    /**
     * Event that updates countdown timer. Posts itself again to {@link #mMessageHandler} to continue updating time.
     */
    private Runnable mCountdownRunnable = new Runnable() {
        public void run() {
            ...
            final String str = getResources().getQuantityString(R.plurals.whats_on_countdown_title, days, days, DateUtils.formatElapsedTime(secs));
