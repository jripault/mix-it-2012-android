...
public class SyncService extends IntentService {
	...
	protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            // TODO : change when the web services will be up and running
            boolean performRemoteSync = false;//performRemoteSync(mResolver, mHttpClient, intent, context);
	...
	/**
	 * Checks for changes to the responses of the Mix-it REST API.
	 */
	private static boolean hasContentChanged(ContentResolver resolver, HttpClient httpClient) { // TODO : change with push notification ?
		for (String url : URLS) {
